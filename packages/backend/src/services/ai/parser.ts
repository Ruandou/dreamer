...
4. **description 必须包含性别与年龄**：每个角色的 description 必须以「性别+年龄」开头，明确标示角色身份，例如「青年男性」「中年女性」「年轻女性」「老年男性」等。从剧本中严格提取，不可省略。若剧本未明确写出年龄，须根据上下文合理推断（如「父亲」推断为中年男性，「少女」推断为年轻女性）。
5. **时代背景与 ethnicity**：若剧本为古装/仙侠/武侠/民国等中国历史题材，角色 description 必须体现「中国人/东亚人」外貌特征（黑发黑眼、黄皮肤、东亚五官），禁止生成欧美人或混血外貌。服装须贴合具体时代（汉服、旗袍、长衫等）。
